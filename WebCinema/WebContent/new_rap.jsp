	    		...
	    		<form>
	    			<table class="editphim">
	    				<tr>
	    					...
	    					<td style="width: 800px;"><input type="input" name="idrap" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Tên rạp: </span></td>
	    					<td><input type="input" name="tenrap" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Địa chỉ: </span></td>
	    					<td><input type="input" name="diachi" value=""></td>
	    				</tr>
	    				...
	    				<tr>
	    					...
	    					<td><input type="input" name="hotline" style="width: 150px;" value=""></td>
	    				</tr>
	    				...
	    				<tr>
	    					...
	    					<td><input type="number" name="quocgia" style="width: 100px; text-align: right;" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Mã các phòng: </span></td>
	    					<td><input type="input" name="maphong" value=""></td>
	    				</tr>
	    				<tr>
	    					<td></td>
	    					<td>
