	...
	<div class="row">
	  <div class="col-2 list-left">
	    ...
	    <div class="nav flex-column nav-pills" sty id="v-pills-tab" role="tablist" aria-orientation="vertical">
	      ...
	      <a class="nav-link muc active" href="admin.jsp"><i class="fa fa-question" id="ico"></i> &nbsp Giải đáp</a>
	    </div>
	  </div>
	    	...
	    	<div>
	    		<form>
	    			<table class="editphim">
	    				<tr>
	    					<td style="width: 150px;"><span>Tên chủ đề: </span></td>
	    					<td style="width: 800px;"><input type="input" name="tencd" value="Thắc mắc về thẻ thành viên" disabled=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Tên tài khoản: </span></td>
	    					<td><input type="input" name="tentk" value="Lê Anh" disabled=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Email: </span></td>
	    					<td><input type="input" name="emailgd" value="leanh@gmail.com" disabled=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Thời gian: </span></td>
	    					<td><input type="input" name="tgian" value="13:46 10/11/2018" disabled=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Nội dung: </span></td>
	    					<td><textarea rows="3" style="width: 660px" disabled="">Thẻ mình là member đăng ký từ năm 2016 sao bây giờ không sử dụng được</textarea></td>
	    				</tr>

	    				<tr>
	    					<td><span>Nội dung trả lời: </span></td>
	    					<td><textarea rows="5" style="width: 660px" value="" ></textarea></td>
	    				</tr>
	    				...
	    				<tr>
	    					...
	    					<td>
	    						...
	    						<input type="submit" class="btn btn-primary" style="width: 100px" name="save" value="Trả lời">
	    					</td>
	    				</tr>
	    			</table>
	    		</form>
