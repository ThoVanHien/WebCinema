	    	...
	    	<div>
	    		<form>
	    			<table class="editphim">
	    				<tr>
	    					<td style="width: 150px;color:white;"><span>Tên phim: </span></td>
	    					<td style="width: 800px;color:white;"><input type="input" name="tenphim" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span style="color:white;">Giờ chiếu: </span></td>
	    					<td><input type="time" name="giochieu" value="" style="width: 140px"></td>
	    				</tr>

	    				<tr>
	    					<td><span style="color:white;">Ngày chiếu: </span></td>
	    					<td><input type="date" name="ngaychieu" value="" style="width: 140px"></td>
	    				</tr>
						
						<tr>
	    					<td><span style="color:white;">Tên phòng: </span></td>
	    					<td>
	    						<select>
	    							<option>R1</option>
	    							<option>R2</option>
	    				...
	    				<tr>
	    					<td><span style="color:white;">Tên rạp: </span></td>
	    					<td>
	    						<select>
