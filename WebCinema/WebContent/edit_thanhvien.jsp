	    		...
	    		<form>
	    			<table class="editphim">
	    				<tr>
	    					...
	    					<td style="width: 800px;"><input type="input" name="iduser" value="7843"></td>
	    				</tr>

	    				<tr>
	    					<td><span>Họ Tên: </span></td>
	    					<td><input type="input" name="username" value="Yến Linh"></td>
	    				</tr>

	    				<tr>
	    					<td><span>Email: </span></td>
	    					<td><input type="input" name="useremail" value="yenlinh@gmail.com"></td>
	    				</tr>

	    				<tr>
	    					<td><span>Mật khẩu: </span></td>
	    					<td><input type="password" name="userpass" value="1234"></td>
	    				</tr>

	    				<tr>
	    					<td><span>Số điện thoại: </span></td>
	    					<td><input type="input" name="userphone" value="0974836284"></td>
	    				</tr>
	    				...
	    				<tr>
	    					...
	    					<td><input type="date" name="userbdate" value="1998-11-20"></td>
	    				</tr>
