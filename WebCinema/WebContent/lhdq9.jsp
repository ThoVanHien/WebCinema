...
<head>
<meta charset="utf-8">
<title>chi tiết rạp quận 9</title>
		...
		<div style="margin-top: 70px">
			<div class="row">
				<div class="col-sm-12 text-center">
					<h1 style="color: red;">LHDStar QUẬN 9</h1>
				</div>
				<div class="row">
					<div class="col-sm-5 zoom " >
						<img src="image/lhdq9.jpg" class="img-fluid" style="border-radius: 20px 20px 0px 20px;height: 620px">
					</div>
					<div class="col-sm-7" style="border-radius: 20px 20px 20px 0px;border-style: dotted;color: white;">
						<p>
							<strong>Địa điểm:</strong> 50 Lê Văn Việt, Hiệp Phú, Quận 9, Hồ Chí Minh <br>
							<strong>Số điện thoại:</strong> 19002099 hoặc 02346250238 <br> 
							<strong>Email:</strong> cskh@bhdstar.vn <br> 
							<strong>Phòng chiếu:</strong> 4 Phòng chiếu <br> 
							<strong>Giờ mở cửa:</strong> 8:30 – 24:00 
						</p>
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15674.234107063567!2d106.778702!3d10.8450577!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x276eb79e46ce1c9b!2zVmluY29tIFBsYXphIEzDqiBWxINuIFZp4buHdA!5e0!3m2!1svi!2s!4v1541522144853" width="650" height="470" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
