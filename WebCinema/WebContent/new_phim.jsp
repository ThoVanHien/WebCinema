	    		...
	    		<form>
	    			<table class="editphim">
	    				<tr>
	    					...
	    					<td style="width: 800px;"><input type="input" name="idphim" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Tên phim: </span></td>
	    					<td><input type="input" name="tenphim" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Thể loại: </span></td>
	    					<td><input type="input" name="theloai" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Khởi chiếu: </span></td>
	    					<td><input type="date" name="khoichieu" style="width: 150px;" value=''></td>
	    				</tr>

	    				<tr>
	    					<td><span>Đạo diễn: </span></td>
	    					<td><input type="input" name="daodien" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Quốc gia: </span></td>
	    					<td><input type="input" name="quocgia" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Diễn viên: </span></td>
	    					<td><textarea rows="3" style="width: 460px"></textarea></td>
	    				</tr>

	    				<tr>
	    					<td><span>Thời lượng: </span></td>
	    					<td><input type="number" name="thoiluong" style="width: 100px; text-align: right;" value=""> phút</td>
	    				</tr>

	    				<tr>
	    					<td><span>Ngôn ngữ: </span></td>
	    					<td><input type="input" name="ngonngu" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Phân loại: </span></td>
	    					<td><input type="input" name="phanloai" value=""></td>
	    				</tr>

	    				<tr>
	    					<td><span>Giá vé: </span></td>
	    					<td><input type="number" name="giave" style="width: 100px; text-align: right;" value=""> VND</td>
	    				</tr>
