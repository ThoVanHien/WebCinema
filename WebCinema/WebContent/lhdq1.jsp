...
<head>
<meta charset="utf-8">
<title>Chi tiết rạp quận 1</title>
		...
		<div style="margin-top: 70px">
			<div class="row">
				<div class="col-sm-12 text-center">
					<h1 style="color: red;">LHDStar QUẬN 1</h1>
				</div>
				<div class="row">
					...
					<div class="col-sm-7" style="border-radius: 20px 20px 20px 0px;border-style: dotted;color: white;">
						<p>
							<strong>Địa điểm:</strong> Lầu 3 & 4, TTTM ICON 68, 2 Hải Triều, Quận 1, TPHCM
							<br>
							<strong>Số điện thoại:</strong> 19002099 hoặc 02346250238 <br> 
							<strong>Email:</strong> cskh@bhdstar.vn <br> 
							<strong>Phòng chiếu:</strong>7 phòng chiếu 2D và 3D<br> 
							<strong>Giờ mở cửa:</strong> 8:30 – 24:00 
						</p>
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15678.05980646297!2d106.7044175!3d10.7718159!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x6322994318a1a010!2sBHD+Star+Cineplex!5e0!3m2!1svi!2s!4v1541575438161" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
